...
[Little Lemon Home page](little-lemon-home-page.png)
...
[Little Lemon Reservation page](little-lemon-reservation-page.png)
...
[Little Lemon reservation profile page](little-lemon-reservation-profile-page.png)

If the customer forgets to input details, they should be presented with relevant warnings.

[Little Lemon reservation profile page with errors](little-lemon-reservation-profile-page-with-errors.png)

Once the customer has completed and submitted the reservation form, they should receive confirmation of their submission.

[Little Lemon reservation confirmation message](little-lemon-reservation-confirmation-message.png)

## Video solution

[Little Lemon video](little-lemon-video-solution.mp4)
